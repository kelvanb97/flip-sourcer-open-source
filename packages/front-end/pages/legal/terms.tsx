    ...
    <Box className="gradient_bg_dark_to_light" minH="100vh">
      <Box marginX={marginX} color="white">
        ...
        <Stack>
          ...
          <Box>
            This website is operated by Flip Sourcer. Throughout the site, the
            terms “we”, “us” and “our” refer to Flip Sourcer. Flip Sourcer
          ...
          <Box>
            ...
            ), you agree that we may, at any time, without restriction, edit,
            copy, publish, distribute, translate and otherwise use in any medium
            any comments that you forward to us. We are and shall be under no
          ...
          <Box>
            ...
            governed by our Privacy Policy. To view our Privacy Policy click{" "}
            <a className="text-indigo-500" href="/privacyPolicy">
              here
            </a>
            .
          </Box>
          ...
          <Box>
            In no case shall Flip Sourcer, our directors, officers, employees,
          ...
          <Box>
            You agree to indemnify, defend and hold harmless Flip Sourcer and
          ...
          <Box>
            When scanning for products using Flip Sourcer scans are used. Your
            account is given X number of scans by default depending on the plan
            that you signed up for. Between 0 and 1.5 scans are used per product
            on a retailers website. However, this amount is subject to change at
